                        ...
                        <table class="table table-centered table-nowrap table-striped" id="products-datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('server.index')}}/edit/{{$data->id}}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                        <a href="{{route('server.index')}}/delete/{{$data->id}}" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                    </td>
                                </tr>
                                @endforeach
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form action="{{route('server.index')}}" method="post">
                    <div class="form-group">
