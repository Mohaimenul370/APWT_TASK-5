            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                        ...
                        <thead>
                            <tr>
                                <th class="pointer" title="Click to sort">Hotspot User</th>
                                <th class="pointer" title="Click to sort">Task</th>
                                <th class="pointer" title="Click to sort">By Admin User</th>
