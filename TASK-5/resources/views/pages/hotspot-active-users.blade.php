            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                        ...
                        <thead>
                            <tr>
                                <th class="align-middle text-center" id="cuser"></th>

                                <th class="pointer" title="Click to sort"></i> User</th>
                                ...
                                <th class="text-right align-middle pointer" title="Click to sort"></i> R.Days</th>
                                <th class="text-right align-middle pointer" title="Click to sort"></i> Bytes Out</th>

                                <!-- <th class="pointer" title="Click to sort"></i>Comments</th> -->
                            </tr>
                        </thead>
                        <tbody>
