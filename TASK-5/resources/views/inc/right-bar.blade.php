<div class="right-bar">
    <div data-simplebar="init" class="h-100">
        <div class="simplebar-wrapper" style="margin: 0px;">
                                ...
                                <div class="tab-pane active" id="settings-tab" role="tabpanel">
                                    ...
                                    <div class="p-3">
                                        ...
                                        <div class="custom-control custom-switch mb-1">
                                            ...
                                            <label class="custom-control-label" for="light-mode-check">Light
                                                Mode</label>
                                        </div>
                                        ...
                                        <!-- Menu positions -->
                                        <h6 class="font-weight-medium font-14 mt-4 mb-2 pb-1">Menus (Leftsidebar and
                                            Topbar) Positon</h6>
                                        ...
                                        <a href="#" class="btn btn-danger btn-block mt-3" target="_blank"><i
                                                class="mdi mdi-basket mr-1"></i> Upgrade Now</a>
            ...
            <div class="simplebar-placeholder" style="width: auto; height: 1285px;"></div>
        </div>
        ...
        <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
            <div class="simplebar-scrollbar"
                style="height: 41px; transform: translate3d(0px, 0px, 0px); display: block;"></div>
        </div>
